...
AddEventHandler('esx_givecarkeys:setVehicleOwnedPlayerId', function (playerId, vehicleProps)
	...
	function (rowsChanged)
		TriggerClientEvent('esx:showNotification', playerId, 'Your car license plate: ~g~' ..vehicleProps.plate..'!', vehicleProps.plate)
	end)
end)
...
RegisterCommand('givekey', function(source, args, user) ----You can change this field.
TriggerClientEvent('esx_givecarkeys:keys', source)
end)